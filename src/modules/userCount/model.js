...
const usersCountAge15ByCountry = (country) => fetchALL(USERS_COUNT_AGE_15_BY_COUNTRY, country)
...
const usersCountAge15ByCountryCity = (country, city) => fetchALL(USERS_COUNT_AGE_15_BY_COUNTRY_CITY, country, city)
