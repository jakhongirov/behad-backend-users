...
const ALL_APP_USER = `
    select 
        app_key, user_id, user_name, user_phone, app_current_version, app_min_version, app_user_isPayed, app_user_interested_to_buy, to_char(app_user_install_date at time zone 'Asia/Tashkent', 'HH24:MI/DD.MM.YYYY')
     from
            apps_user a
     inner join
            users b
