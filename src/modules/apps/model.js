...
const addApp = (name, current_vs, min_vs, key) => fetch(ADD_APP, name, current_vs, min_vs, key)
const putApp = (id, name, current_vs, min_vs, key) => fetch(UPADATE_APP, id, name, current_vs, min_vs, key)
